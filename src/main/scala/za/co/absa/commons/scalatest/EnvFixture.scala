...
import za.co.absa.commons.scalatest.ReflectionUtils.extractValue
...
object EnvFixture {
  ...
  private class TheUnmodifiableEnvironment extends MapHandler {
    override protected val m: EnvMap = extractValue[EnvMap](System.getenv(), "m")
  }
  ...
  private class TheCaseInsensitiveEnvHandler extends MapHandler {
    override protected val m: EnvMap = {
      ...
      extractValue[Class[_], EnvMap](pe, "theCaseInsensitiveEnvironment")(ClassTag(pe))
    }
  }
